// OLD code for the RandomNumberGenerator contract (prior to using an interface)


// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;

import {VRFv2Consumer} from "../src/vrfv2consumer.sol";     // <-- use IVRFv2Consumer instead
...
contract RandomNumberGenerator {
    ...
    function requestRandomWords() public {
        vrfv2consumer.requestRandomWords();         //  <--  HERE is the start of the error
    }
